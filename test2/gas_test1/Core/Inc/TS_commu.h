...
typedef enum { Splash = 10, Main = 11, Config = 41, Alarm = 45, PW_Input = 111, PW_Change = 112, PW_Wrong = 113, PW_Change_OK = 114, AlertAlarm = 120 } Window_t;
...
typedef struct{
	...
	unsigned EmerSWOnLamp:1;		// 200 --> 199 --> 201
	unsigned SubEmerSWOnLamp:1;		// 201 --> 200 --> 202
	unsigned PressureLowLimit:1;	// 202 --> 201 --> 203
	unsigned PrepChgPT1:1;			// 203 --> 202 --> 204
	unsigned PrepChgPT1Alarm:1;		// 204 --> 203 --> 205
	unsigned PrepChgPT2:1;			// 205 --> 204 --> 206
	unsigned PrepChgPT2Alarm:1;		// 206 --> 205 --> 207
	unsigned MinSuuplPressPT3:1;	// 207 --> 206 --> 208
	unsigned rsvd208:1;
