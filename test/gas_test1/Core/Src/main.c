...
//	  HAL_ADC_Start_IT(hadc1);
	  ...
	  if(adcdata3 > 819) {
		  PT1.Value = (uint16_t)(10 * ((adcdata3 -819) * PT1scale + PT1.MinSValue) + PT1.Offset);
	  } else {
	  ...
	  if (adcdata2 > 819)
	      PT2.Value = (uint16_t)(10 * ((adcdata2 - 819) * PT2scale + PT2.MinSValue) + PT2.Offset);
