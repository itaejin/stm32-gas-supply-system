...
typedef enum { Main = 11, Config = 41, Alarm = 45, PW_Input = 111, PW_Change = 112, PW_Wrong, PW_Change_OK, AlertAlarm = 120 } Window_t;
...
typedef struct {
    ...
    // uint16_t EnteredValue;   // 사용자가 4x90에 입력한 값
} Password_t;
